package com.lijipeng.search.manager.core;
...
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.lijipeng.search.manager";//项目基础包名称，根据自己公司的项目修改
    
    public static final String REDIS_PRE = "search-mgr_";

    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".po";//Model所在包
